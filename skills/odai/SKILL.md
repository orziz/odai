...
8. 涉及清单状态源、清单回写、执行静默态或继续推进时，读取 `references/harness-dev/workflow-kit.md`；涉及 UI 视觉提质时，按 `references/design-spec/ui-visual-playbook.md` 与 `references/design-spec/aesthetic-benchmark.md` 补足审美和状态验收。
