...
当前已发布双包为 DSH `0.2.31`；源码候选为未发布 `0.2.32`，canonical `0.3.16` / runtime contract `6`，支持精确 DSH `0.1.5-rc.1`。使用与配置合同以 [`dsh/README.md`](../dsh/README.md) 为准，当前任务评分见 [`evaluation-results.md`](evaluation-results.md)。本页只保留当前有用的证据及限制；旧版本实验过程由 Git 历史承载。
