...
涉及问题整理、工作草案字段、规划文档结构或提问分组时，统一沿用 `odai/references/dao/terminology-baseline.md` 的术语与字段名。交互确认、待确认项清空和结果总结展示层级统一按 `odai/references/dao/interaction-contract.md`；本模块只补规划边界与规格产物规则。
...
4. 提问通道与文字兜底统承交互契约；本模块只补规划问题必须按目标、场景、边界和落地层级组织。
