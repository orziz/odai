...
## Unreleased — DSH 0.2.30 / canonical 0.3.12
...
- 双包继续归入同一未发布候选 `0.2.30`；canonical 更新为 `0.3.12`，runtime contract `6`、required files 与精确 DSH `0.1.5-rc.1` peer 不变。不迁移或改写历史成绩，也不宣称新模型能力计分已通过；本地合同、回归与有界语义复核不冒充跨模型能力或成本证明。
