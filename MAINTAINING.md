...
skills/odai/                      odai canonical source
  ...
  references/capabilities/        规划、设计、交付、审查与文档整理
...
| 规划、设计、诊断与实施、代码审查、文档整理 | `references/capabilities/`；诊断与实施由 `delivery.md` 承担，日报与项目指南由 `documentation.md` 承担 |
...
能力文件统一为 `planning`、`design`、`delivery`、`review`、`documentation`，不是必经路由或独立安装包。`references/recipes/` 仍保持退役；日报、变更文案和项目指南的必要语义统一由 `documentation.md` 按需承接，不恢复旧目录或平行工作流。
