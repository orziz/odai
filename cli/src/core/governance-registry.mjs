const RUNTIME_RULE_COUPLINGS = [
  {
    ...
    sourceRefs: ["skills/odai/SKILL.md:总纲", "skills/odai/references/dao/leverage.md:再决定是否下放"],
  ...
  },
  {
    ...
    sourceRefs: ["skills/odai/SKILL.md:守界、验成与知止", "skills/odai/references/capabilities/delivery.md:命中边界"],
  ...
  },
  {
    ...
    sourceRefs: ["skills/odai/references/capabilities/delivery.md:再闭合结果", "skills/odai/references/dao/continuity.md:主状态"],
  ...
  },
  {
    ...
    sourceRefs: ["skills/odai/references/capabilities/delivery.md:命中边界"],
  ...
  },
  {
    ...
    sourceRefs: ["skills/odai/SKILL.md:成事主线", "skills/odai/references/capabilities/delivery.md:先辨因"],
  ...
  },
  {
    ...
    sourceRefs: ["skills/odai/SKILL.md:成事主线", "skills/odai/references/dao/authority.md:模糊与感知任务"],
  ...
  },
  {
    ...
    sourceRefs: ["skills/odai/SKILL.md:守界、验成与知止", "skills/odai/references/dao/authority.md:动作边界"],
  ...
  },
  {
    ...
    sourceRefs: [
      "skills/odai/SKILL.md:守界、验成与知止",
      "skills/odai/references/capabilities/delivery.md:命中边界",
    ],
