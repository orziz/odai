const RUNTIME_RULE_COUPLINGS = [
  {
    ...
    sourceRefs: ["skills/odai/SKILL.md:governance-principles[4]", "skills/odai/references/modules/dao.md:controller-rules[9]"],
  ...
  },
  {
    ...
    sourceRefs: ["skills/odai/SKILL.md:governance-principles[5]", "skills/odai/references/implement-code/special-cases.md:external-input-and-model-output"],
  ...
  },
  {
    ...
    sourceRefs: ["skills/odai/references/modules/implement-code.md:implementation-rules[5]", "skills/odai/references/modules/implement-code.md:verification[1]"],
  ...
  },
  {
    ...
    sourceRefs: ["skills/odai/references/implement-code/special-cases.md:external-input-and-model-output"],
  ...
  },
  {
    ...
    sourceRefs: ["skills/odai/SKILL.md:general-principles[6]", "skills/odai/references/modules/implement-code.md:verification[5]"],
  ...
  },
  {
    ...
    sourceRefs: ["skills/odai/SKILL.md:general-principles[7]", "skills/odai/references/modules/dao.md:controller-rules[4]"],
  ...
  },
  {
    ...
    sourceRefs: ["skills/odai/SKILL.md:governance-principles[5]", "skills/odai/references/modules/implement-code.md:implementation-rules[5]"],
  ...
  },
  {
    ...
    sourceRefs: ["skills/odai/SKILL.md:governance-principles[3]", "skills/odai/references/modules/dao.md:controller-rules[9]"],
  ...
  },
  {
    ...
    sourceRefs: ["skills/odai/SKILL.md:general-principles[8]", "skills/odai/references/implement-code/special-cases.md:external-input-and-model-output"],
  ...
  },
  {
    ...
    sourceRefs: [
      "skills/odai/SKILL.md:governance-principles[5]",
      "skills/odai/references/implement-code/special-cases.md:external-input-and-model-output",
    ],
