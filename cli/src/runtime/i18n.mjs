...
const TRANSLATIONS = {
  en: {
    ...
    "slash.skills": "List discovered skills and session enables",
    "slash.skill": "Enable skill for this session: {name}",
    "slash.skillSystem": "odai system governance skill (always on)",
  ...
  zh: {
    ...
    "slash.skills": "列出已发现技能与本会话启用项",
    "slash.skill": "为本会话启用技能: {name}",
    "slash.skillSystem": "odai 系统治理技能（始终开启）",
    "slash.help": "显示命令帮助",
    "slash.retry": "重试上一个任务",
    "slash.exit": "退出 odai",
    "completion.provider": "Provider",
