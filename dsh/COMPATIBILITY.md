...
| --- | --- | --- | --- |
| `0.2.28` | `0.2.28` | `0.1.5-rc.1` | 当前未发布候选；Odai 自有 preset、新版 Web 依赖和提示/工具边界适配；不声明历史 v0 Odai 日志已完成迁移，旧补标记入口已退役 |
...
2. `0.2.15` 至 `0.2.18` 只支持精确的 `0.1.1-rc.2` 与 `0.1.2-alpha.2`；`0.2.19` 只支持精确的 rc.2 与 alpha.4。`0.2.20`、`0.2.21` 与 `0.2.22` 按已发布合同保留 rc.2 和后续 `0.1.2` prerelease 范围；`0.2.23` 至 `0.2.27` 只支持精确 `0.1.2-rc.1`。`0.2.28` 当前候选仅面向精确 `0.1.5-rc.1`。
