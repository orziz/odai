...
| --- | --- | --- | --- |
| `0.2.16` | `0.2.16` | `0.1.1-rc.2`、`0.1.2-alpha.2` | 当前未发布候选；在 0.2.15 契约上增加 Agent/Plugin 共享中文 Control Center、受 loopback 保护的真实 evidence/routing RPC、Agent `[Y/n]` 安装入口，以及单装和双装共存 |
...
2. “支持的 DSH”是精确白名单。`0.2.15` 与 `0.2.16` 仅支持 `0.1.1-rc.2` 与 `0.1.2-alpha.2`，不自动承诺兼容其他 rc、alpha 或 `0.1.2` 版本。
