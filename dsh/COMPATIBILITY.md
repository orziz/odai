...
| --- | --- | --- | --- |
| `0.2.30` | `0.2.30` | `0.1.5-rc.1` | 两包于 2026-09-11 发布；版本已消耗，不复用 |
| `0.2.31` | `0.2.31` | `0.1.5-rc.1` | 未发布候选；原生职责路由与父会话回执衔接；canonical 0.3.15 / runtime contract 6；退役僵硬分工，区分局部阻断与整体停手，子代理只读补丁回交、职责 owner 正文随同快照传递，强化协作讨论与可检验判断，通用角色去卡片格式、整体交付与单一路径契约，Hooks 实际路径边界、旧日志改写实现退役及双包维护入口整理 |
