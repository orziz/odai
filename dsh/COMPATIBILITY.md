...
| --- | --- | --- | --- |
| `0.2.29` | `0.2.29` | `0.1.5-rc.1` | 当前未发布候选；canonical 0.3.11 / runtime contract 6；同命令重复非成功结果触发去重提醒，不硬拦截预期红测或重复实验 |
...
2. `0.2.15` 至 `0.2.18` 只支持精确的 `0.1.1-rc.2` 与 `0.1.2-alpha.2`；`0.2.19` 只支持精确的 rc.2 与 alpha.4。`0.2.20`、`0.2.21` 与 `0.2.22` 按已发布合同保留 rc.2 和后续 `0.1.2` prerelease 范围；`0.2.23` 至 `0.2.27` 只支持精确 `0.1.2-rc.1`。`0.2.28` 及当前 `0.2.29` 候选仅面向精确 `0.1.5-rc.1`。
