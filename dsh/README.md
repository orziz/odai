...
Choose one surface for the scope you need. The Plugin manager requires `pnpm` on `PATH`; the `0.2.18` Agent installer candidate supports exactly `dsh@0.1.1-rc.2` and `dsh@0.1.2-alpha.2`.
