...
The current `0.3.10` candidate has no model evaluation results yet. A frozen `0.3.9` Sol/high snapshot scored 18/19 and 142/144; see [`docs/evaluation-results.md`](docs/evaluation-results.md) for its scope and fingerprint. Neither that score nor the `0.3.8` and older results below certify current sources.
