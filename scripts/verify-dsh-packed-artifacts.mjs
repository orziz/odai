...
const agentExpected = new Map([
  ...
  ["package/preset.cordis.patch.yml", await readFile(resolve(repoRoot, "dsh/agent/preset.cordis.patch.yml"))],
  ["package/preset/odai/package.json", await readFile(resolve(repoRoot, "dsh/agent/preset/odai/package.json"))],
