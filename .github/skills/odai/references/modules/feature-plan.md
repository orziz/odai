...
涉及问题整理、工作草案字段、规划文档结构或提问分组时，统一沿用 `references/dao/terminology-baseline.md` 的术语与字段名。交互确认、待确认项清空和结果总结展示层级统一按 `references/dao/interaction-contract.md`；本模块只补规划边界与规格产物规则。
